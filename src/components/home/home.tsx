  ...
  return (
    <div className="container">
      <div className="header">
        ...
        <div className="header__right">
          <a
            ...
            className="header__right__margin"
          >
            Github
          </a>
        </div>
      ...
      <div className="body">
        ...
        <span className="body__sub-title">
        ...
        <form onSubmit={onSubmit} className="body__form">
          ...
          <div className="body__form__create">
            ...
            <span className="body__form__create__small-text">
              Secure and simple
            </span>
          </div>
        </form>
